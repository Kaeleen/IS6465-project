...
<html>
    <head>
        <title>Update Advisor Information</title>
    ...
    <!-- Header -->
        ...
        <div class="container-fluid bg-grey text-center" >
            <div class="row">
                <div class="col">
                    <h2 class="head">Update Advisor Information</h2>
                </div>
            </div>
                        ...
                        if(mysqli_num_rows($result) > 0)
                        {
                            while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                <div class="form-group col-md-6">
                                    <label class="control-label col-md-4" for="advisorName">Name:</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="name" id="" value="<?php echo  $row['name'];  ?>">
                                        <input class="form-control" type="hidden" name="id" id="" value="<?php echo  $row['advisor_id'];  ?>">
                                    </div>
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="control-label col-md-4" for="advisorName">Password:</label>
                                    <div class="col-md-8">
                                        <input class="form-control" type="text" name="password" id="" value="<?php echo  $row['password'];  ?>">
                                    </div>
                                </div>
