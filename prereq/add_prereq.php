...
<html lang="en">
    <head>
        <title>Add Prerequisite Information</title>
    ...
    <!-- Header -->
        ...
        <div class="container-fluid bg-grey text-center" >
            <div class="row">
                <div class="col">
                    <h2 class="head">Add Prerequisite Information</h2>
                </div>
            </div>

            <form class="form-horizontal" action="add_prereq_do.php" method="post">
