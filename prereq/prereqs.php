...
<html>
    <head>
        <title>Prequisite Options</title>
    ...
    <!-- Table -->
        <div class="container-fluid bg-grey text-center" >
            <div class="row">
                <div class="col">
                    <a href="add_prereq.php">Add Prerequisite Information</a><br>
                    <?php echo mysqli_num_rows($result); ?> prerequisites exist.
                </div>
            </div>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) 
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="detail_prereq.php?id=<?php echo  $row['prereq_id'];  ?>">Details</a>
                                </td>
                            </tr>
                            <?php
                        }
