        ...
        <form action="edit_do.php" method="post">
            ...
            if(mysqli_num_rows($result) > 0)
            {
                while($row = mysqli_fetch_assoc($result))
                {
                    ...
                    <div>
                        <p>Name:</p>
                        <input type="text" name="name" id="" value="<?php echo  $row['program_name'];  ?>">
                        <input type="hidden" name="id" id="" value="<?php echo  $row['program_id'];  ?>">
                    </div>
                    <div>
                        <p>type:</p>
                        <input type="text" name="type" id="" value="<?php echo  $row['type'];  ?>">
                    </div>
                    <div>
